...
var (
	...
	serverAddr         = flag.String("addr", "localhost:58582", "The server address in the format of host:port")
...
func CreateMessage(userId int32, chatId int32, content string, isDelivered []int32, imgLink string) {
